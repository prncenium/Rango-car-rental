    ...
    >
      <div className="flex flex-col gap-16 lg:gap-24">
        ...
        <div className="grid grid-cols-1 items-start gap-x-20 gap-y-10 sm:grid-cols-2 lg:gap-x-32">
          ...
          <div className="flex justify-start pt-[9.5rem] sm:justify-end">
            <GalleryImage
        ...
        <div className="grid grid-cols-1 gap-x-20 sm:grid-cols-2 lg:gap-x-32">
          <div className="flex justify-start -mt-[8.5rem]">
            <GalleryImage
        ...
        <div className="grid grid-cols-1 gap-x-20 sm:grid-cols-2 lg:gap-x-32">
          <div className="flex justify-start -mt-[18.35rem] sm:col-start-2 sm:justify-end">
            <GalleryImage
